...
const fileOverview = buildOperationsOverview({
  version:"7.69.47", environment:"Local", uptimeSeconds:12, nodeVersion:process.version,
...
const postgresOverview = buildOperationsOverview({
  version:"7.69.47", releaseIdentifier:"v7.69.47-deadbeef", environment:"Production", uptimeSeconds:3600, nodeVersion:process.version,
...
const failedMigrationOverview = buildOperationsOverview({
  version:"7.69.47", environment:"Production", backend:"POSTGRES", databaseRequired:true,
...
const mismatchOverview = buildOperationsOverview({
  version:"7.69.47", environment:"Production", backend:"POSTGRES", databaseRequired:false,
