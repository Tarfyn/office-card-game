...
const fileOverview = buildOperationsOverview({
  version:"7.69.54", environment:"Local", uptimeSeconds:12, nodeVersion:process.version,
...
const postgresOverview = buildOperationsOverview({
  version:"7.69.54", releaseIdentifier:"v7.69.54-deadbeef", environment:"Production", uptimeSeconds:3600, nodeVersion:process.version,
...
const failedMigrationOverview = buildOperationsOverview({
  version:"7.69.54", environment:"Production", backend:"POSTGRES", databaseRequired:true,
...
const mismatchOverview = buildOperationsOverview({
  version:"7.69.54", environment:"Production", backend:"POSTGRES", databaseRequired:false,
