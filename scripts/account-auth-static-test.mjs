...
const fileOverview = buildOperationsOverview({
  version:"7.69.46", environment:"Local", uptimeSeconds:12, nodeVersion:process.version,
...
const postgresOverview = buildOperationsOverview({
  version:"7.69.46", releaseIdentifier:"v7.69.46-deadbeef", environment:"Production", uptimeSeconds:3600, nodeVersion:process.version,
...
const failedMigrationOverview = buildOperationsOverview({
  version:"7.69.46", environment:"Production", backend:"POSTGRES", databaseRequired:true,
...
const mismatchOverview = buildOperationsOverview({
  version:"7.69.46", environment:"Production", backend:"POSTGRES", databaseRequired:false,
