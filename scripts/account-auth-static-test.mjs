...
const fileOverview = buildOperationsOverview({
  version:"7.69.53", environment:"Local", uptimeSeconds:12, nodeVersion:process.version,
...
const postgresOverview = buildOperationsOverview({
  version:"7.69.53", releaseIdentifier:"v7.69.53-deadbeef", environment:"Production", uptimeSeconds:3600, nodeVersion:process.version,
...
const failedMigrationOverview = buildOperationsOverview({
  version:"7.69.53", environment:"Production", backend:"POSTGRES", databaseRequired:true,
...
const mismatchOverview = buildOperationsOverview({
  version:"7.69.53", environment:"Production", backend:"POSTGRES", databaseRequired:false,
