...
test("v7.27 covers onboarding attack state keyword shield and altered attack limit", () => { for (const token of ['ONBOARDING', 'ATTACK_USED', 'ATTACK_RESTRICTED', 'KEYWORD', 'DESTRUCTION_SHIELD', 'ATTACK_LIMIT'])
