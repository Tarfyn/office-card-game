...
test("v7.32 labels any outlier signal by sample strength", () => { for (const s of r.analytics.signals)
    assert.ok(["TINY", "SMALL", "DIRECTIONAL", "STRONGER"].includes(s.sampleLabel)); });
