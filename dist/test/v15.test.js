...
test("balance runner covers all ten starter matchups deterministically", () => {
    ...
    assert.deepEqual(a.games.map((g) => [g.p1Deck, g.p2Deck, g.firstPlayer, g.winner, g.turnNumber, g.reason]), b.games.map((g) => [g.p1Deck, g.p2Deck, g.firstPlayer, g.winner, g.turnNumber, g.reason]));
});
