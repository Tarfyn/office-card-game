...
test("pending attack projection exposes only public attacker/target references", () => {
    ...
    state.cards[attacker].zone = "EMPLOYEE_FIELD";
    state.cards[attacker].slot = 0;
    state.players.P1.employeeField[0] = attacker;
    state.cards[defender].zone = "EMPLOYEE_FIELD";
    state.cards[defender].slot = 0;
    state.players.P2.employeeField[0] = defender;
