...
assert.equal(packageJson.version, "7.69.48");
assert.equal(packageLock.version, "7.69.48");
assert.equal(packageLock.packages[""].version, "7.69.48");
...
console.log("v7.69.48 cosmetic release markers passed.");
