...
test("v7.69.44 removes the obsolete T1 silver corner treatment",()=>{
...
test("v7.69.44 gives T1/T2/T3 restrained metallic typography",()=>{
...
console.log(`${passed}/8 v7.42/v7.69.44 tests passed.`);
