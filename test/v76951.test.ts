...
assert.equal(packageLock.version, "7.69.72");
assert.equal(packageLock.packages[""].version, "7.69.72");
assert.match(server, /version: "7\.69\.72"/);
assert.match(server, /version:"7\.69\.72"/);
...
console.log("v7.69.72 Executive Edition variant ownership release-gate markers passed.");
