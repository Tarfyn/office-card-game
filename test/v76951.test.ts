...
assert.equal(packageLock.version, "7.69.58");
assert.equal(packageLock.packages[""].version, "7.69.58");
...
console.log("v7.69.58 Starter Onboarding release-gate markers passed.");
