...
assert.equal(packageLock.version, "7.69.76");
assert.equal(packageLock.packages[""].version, "7.69.76");
assert.match(server, /version: "7\.69\.76"/);
assert.match(server, /version:"7\.69\.76"/);
...
console.log("v7.69.76 Executive Edition variant ownership release-gate markers passed.");
