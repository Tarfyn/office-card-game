...
assert.equal(packageJson.version, "7.69.67");
assert.equal(packageLock.version, "7.69.67");
assert.equal(packageLock.packages[""].version, "7.69.67");
...
console.log("v7.69.67 Executive Edition variant ownership release-gate markers passed.");
