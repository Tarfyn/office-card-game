...
assert.equal(packageJson.version, "7.69.61");
assert.equal(packageLock.version, "7.69.61");
assert.equal(packageLock.packages[""].version, "7.69.61");
assert.match(server, /version: "7\.69\.61"/);
assert.match(server, /version:"7\.69\.61"/);
...
console.log("v7.69.61 Starter Intern release-gate markers passed.");
