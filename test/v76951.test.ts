...
assert.equal(packageLock.version, "7.69.77");
assert.equal(packageLock.packages[""].version, "7.69.77");
assert.match(server, /version: "7\.69\.77"/);
assert.match(server, /version:"7\.69\.77"/);
...
console.log("v7.69.77 Executive Edition variant ownership release-gate markers passed.");
