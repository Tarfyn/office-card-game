...
assert.equal(packageJson.version, "7.69.53");
assert.equal(packageLock.version, "7.69.53");
assert.equal(packageLock.packages[""].version, "7.69.53");
...
console.log("v7.69.53 Starter Onboarding release-gate markers passed.");
