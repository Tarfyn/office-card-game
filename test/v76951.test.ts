...
assert.equal(packageJson.version, "7.69.63");
assert.equal(packageLock.version, "7.69.63");
assert.equal(packageLock.packages[""].version, "7.69.63");
assert.match(server, /version: "7\.69\.63"/);
assert.match(server, /version:"7\.69\.63"/);
...
console.log("v7.69.63 Starter Intern release-gate markers passed.");
