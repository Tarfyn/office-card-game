...
assert.equal(packageJson.version, "7.69.52");
assert.equal(packageLock.version, "7.69.52");
assert.equal(packageLock.packages[""].version, "7.69.52");
...
console.log("v7.69.52 Starter Onboarding release-gate markers passed.");
