...
assert.equal(packageJson.version, "7.69.57");
assert.equal(packageLock.version, "7.69.57");
assert.equal(packageLock.packages[""].version, "7.69.57");
...
console.log("v7.69.57 Starter Onboarding release-gate markers passed.");
