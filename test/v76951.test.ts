...
assert.equal(packageJson.version, "7.69.66");
assert.equal(packageLock.version, "7.69.66");
assert.equal(packageLock.packages[""].version, "7.69.66");
...
console.log("v7.69.66 Executive Edition variant ownership release-gate markers passed.");
