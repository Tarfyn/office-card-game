...
assert.match(styles, /--exec-foil-opacity:\.56/);
assert.match(styles, /repeating-linear-gradient\(104deg,transparent 0 12px/);
assert.match(styles, /filter:saturate\(1\.28\) contrast\(1\.08\)/);
assert.match(styles, /\.hover-card-face\.executive-edition \{ --exec-foil-opacity:\.64; \}/);
